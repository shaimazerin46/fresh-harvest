        ...
        <div
            ...
            className='object-cover lg:h-[1000px] lg:w-full lg:px-[120px] px-4  relative'>
                ...
                <div className='pt-[178px] lg:w-[660px] relative'>
                    ...
                    <h3 className='lg:text-[80px] font-bold text-[32px] '>Fresh Fruits and Vegetables</h3>
                    ...
                    <div className='mt-5 ml-10 lg:ml-0 lg:absolute lg:right-0 z-10'>
                        ...
                        <div className='flex items-center gap-1  bg-[#EBEBEB] lg:px-4 px-2 lg:py-2 py-1 w-[190px] lg:w-[331px] h-[91px] lg:h-[157px] rounded-xl'>
                            <div className='font-bold space-y-[3px]'>
                                ...
                                <h3 className='uppercase h-[15px] lg:h-[26px] flex items-center justify-center bg-green-600  text-white rounded-3xl text-[6px] lg:text-[12px] font-bold'>code:<h2 className='text-yellow-300'>fresh25</h2></h3>
                    ...
                    <div className='mt-[25px] absolute lg:-bottom-64 -bottom-120'>
